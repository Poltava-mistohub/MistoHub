...
`,sc=({controlsMenuModal:t})=>{const{activeSection:e,isModalOpen:n,openModal:i,closeModal:r}=t,a={top:"0",left:"0",overlay:{zIndex:"100"}};return o.jsxs(_u,{style:a,isOpen:n.menu_modal,onRequestClose:()=>r("menu_modal"),shouldCloseOnEsc:!0,shouldCloseOnOverlayClick:!1,children:[o.jsxs(ec,{children:[o.jsx(Le,{children:"Меню"}),o.jsxs(tc,{children:[o.jsx($u,{type:"button",onClick:()=>i("join_modal"),children:"Підтримати проєкт"}),o.jsx(Lt,{onClose:()=>r("menu_modal")})]})]}),o.jsxs(ic,{children:[o.jsx(Gu,{closeModal:r,activeSection:e}),o.jsx(nc,{children:o.jsx(U,{iconName:"misto-hub-logo",width:"357",height:"121"})})]}),o.jsxs("div",{children:[o.jsxs(rc,{children:[o.jsx("span",{children:o.jsx(Le,{children:"© ГО «МІСТО ХАБ»"})}),o.jsx(Le,{children:"Всі права захищені"}),o.jsx(Le,{children:"|"}),o.jsxs(ac,{type:"button",onClick:()=>i("team_modal"),children:[o.jsx("span",{children:"Poзроблено студентами"}),o.jsx(U,{iconName:"logoGoIT",width:"100",height:"30"})]})]}),o.jsx(Ri,{maxWidth:767,children:o.jsx(Pi,{sectionName:"menu"})})]})]})},oc=F.div`
  display: flex;
  flex-direction: column;
  align-items: center;
