...
`,Ib=({people:t=[],companies:e=[]})=>{const{openModal:n}=pi();return b.jsx(Sb,{id:"how",children:b.jsxs(Ab,{children:[b.jsx(Eb,{children:"Приєднуйся до спільноти людей, які змінюють Полтаву!"}),b.jsx(Tb,{children:"Саме імпакт-інвестори будуть впливати на розподіл коштів серед проєктів містян"}),b.jsxs(Cb,{children:[b.jsx(Mb,{children:"До відкриття МІСТОХАБ залишилось:"}),b.jsxs(Ob,{children:[b.jsxs(Dr,{children:[116-t.length," ",Br(116-t.length,"i")]}),b.jsxs(Dr,{children:[17-e.length," ",Br(17-e.length,"k")]})]})]}),b.jsx(Pb,{type:"button",onClick:()=>n("join_modal"),children:"Приєднатися"}),b.jsxs(kb,{children:[b.jsx("p",{children:(t==null?void 0:t.length)>100&&b.jsx("span",{children:"100+ людей"})}),b.jsx("p",{children:(e==null?void 0:e.length)>10&&b.jsx("span",{children:"10+ компаній"})}),"вже приєдналися"]}),b.jsx(cb,{})]})})},Rb=O.lazy(()=>ut(()=>import("./Visualization-0d9dfc95.js"),["assets/Visualization-0d9dfc95.js","assets/index-95d60aa3.js","assets/index-a6b3472e.css","assets/Visualization-68f18769.css"])),Lb=O.lazy(()=>ut(()=>import("./AccumulatedMoney-37b0e24e.js"),["assets/AccumulatedMoney-37b0e24e.js","assets/index-95d60aa3.js","assets/index-a6b3472e.css","assets/hoist-non-react-statics.cjs-3f8ebaa8.js"])),jb=O.lazy(()=>ut(()=>import("./InvestorsBlock-976d310d.js"),["assets/InvestorsBlock-976d310d.js","assets/index-95d60aa3.js","assets/index-a6b3472e.css"])),Nb=O.lazy(()=>ut(()=>import("./Footer-6aac6325.js"),["assets/Footer-6aac6325.js","assets/index-95d60aa3.js","assets/index-a6b3472e.css"])),zb=O.lazy(()=>ut(()=>import("./ModalsManager-61736240.js"),["assets/ModalsManager-61736240.js","assets/index-95d60aa3.js","assets/index-a6b3472e.css","assets/hoist-non-react-statics.cjs-3f8ebaa8.js"]));$l.setAppElement("#root");const Bb=()=>{const[t,e]=O.useState("main"),n=Ao(),[i,r]=O.useState([]),[s,o]=O.useState([]),a=O.useMemo(()=>async()=>{try{const[l,u]=await Promise.all([Ua(),Wa()]);r(l),o(u)}catch(l){console.error("Error fetching data:",l)}},[]);return O.useEffect(()=>{a()},[a]),O.useEffect(()=>{const{hash:l}=n;if(l){const u=l.substring(1),c=document.getElementById(u);c&&window.scrollTo({top:c.offsetTop-100,behavior:"smooth"})}},[n]),O.useEffect(()=>{const l=()=>{document.querySelectorAll("section").forEach(c=>{const p=document.getElementById("about").offsetTop;window.scrollY<p-110&&e("main");const m=c.offsetTop,h=c.offsetHeight,g=c.getAttribute("id");if(window.scrollY>=m-100&&window.scrollY<m+h-100){e(g);const y=`/MistoHub/#${g}`;g!==null?window.history.pushState(null,"",y):window.history.pushState(null,"",window.location.pathname)}})};return window.addEventListener("scroll",l),()=>{window.removeEventListener("scroll",l)}},[]),b.jsxs(b.Fragment,{children:[b.jsx(Lc,{}),b.jsxs("main",{children:[b.jsx(am,{}),b.jsx(Nf,{}),b.jsx(Rb,{}),b.jsx(Lb,{}),b.jsx(jb,{people:s,companies:i}),b.jsx(Ib,{people:s,companies:i}),b.jsx(kg,{}),b.jsx(zh,{})]}),b.jsx(Nb,{}),b.jsx(zb,{activeSection:t})]})},Vb=Object.freeze(Object.defineProperty({__proto__:null,default:Bb},Symbol.toStringTag,{value:"Module"}));export{mi as C,Vb as H,fe as I,$l as M,hi as S,ee as a,pi as b,Rc as c,au as d,Wb as e,Hb as f,Br as g,ln as h,we as i,Ce as m,bo as n,Fb as p,Qu as s,Ts as u};
