import{u as t,j as e}from"./index-23659ed8.js";import{S as o,u as n}from"./HomePage-602f3375.js";const s="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";let d=(i=21)=>{let a="",p=crypto.getRandomValues(new Uint8Array(i));for(;i--;)a+=s[p[i]&63];return a};const b=t.div``,A=t.img`
  position: absolute;
  top: 484px;
  left: 27px;
  width: 84px;
...
`,de=({people:i=[],companies:a=[]})=>{const{openModal:p}=n();return e.jsx(ee,{id:"how",children:e.jsxs(ie,{children:[e.jsx(te,{children:"Приєднуйся до спільноти людей, які змінюють Полтаву!"}),e.jsx(ae,{children:"Саме імпакт-інвестори будуть впливати на розподіл коштів серед проєктів містян"}),e.jsx(pe,{type:"button",onClick:()=>p("join_modal"),children:"Приєднатися"}),e.jsxs(oe,{children:[e.jsx("p",{children:(i==null?void 0:i.length)>100&&e.jsx("span",{children:"100+ людей"})}),e.jsx("p",{children:(a==null?void 0:a.length)>10&&e.jsx("span",{children:"10+ компаній"})}),"вже приєдналися"]}),e.jsx(y,{})]})})};export{de as default};
