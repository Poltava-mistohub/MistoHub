import{u as t,j as e,S as o,a as n}from"./index-f2da1e2a.js";const s="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";let d=(i=21)=>{let a="",p=crypto.getRandomValues(new Uint8Array(i));for(;i--;)a+=s[p[i]&63];return a};const b=t.div``,A=t.img`
  position: absolute;
  top: 484px;
  left: 27px;
  width: 84px;
