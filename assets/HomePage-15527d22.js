...
`,Hb=({people:t=[],companies:e=[]})=>{const{openModal:n}=ki();return b.jsx(Pb,{id:"how",children:b.jsxs(Ib,{children:[b.jsx(Rb,{children:"Приєднуйся до спільноти людей, які змінюють Полтаву!"}),b.jsx(Lb,{children:"Саме імпакт-інвестори будуть впливати на розподіл коштів серед проєктів містян"}),b.jsxs(jb,{children:[b.jsx(zb,{children:"До відкриття МІСТОХАБ залишилось:"}),b.jsxs(Nb,{children:[b.jsxs(es,{children:[116-t.length," ",$r(116-t.length,"i")]}),b.jsxs(es,{children:[17-e.length," ",$r(17-e.length,"k")]})]})]}),b.jsx(Bb,{type:"button",onClick:()=>n("join_modal"),children:"Приєднатися"}),b.jsxs(Db,{children:[b.jsx("p",{children:(t==null?void 0:t.length)>100&&b.jsx("span",{children:"100+ людей"})}),b.jsx("p",{children:(e==null?void 0:e.length)>10&&b.jsx("span",{children:"10+ компаній"})}),"вже приєдналися"]}),b.jsx(bb,{})]})})},Fb=O.lazy(()=>ut(()=>import("./Visualization-ae8bbb63.js").then(t=>t.V),["assets/Visualization-ae8bbb63.js","assets/index-b40e5c0f.js","assets/index-a6b3472e.css"])),Ub=O.lazy(()=>ut(()=>import("./AccumulatedMoney-230b18e6.js"),["assets/AccumulatedMoney-230b18e6.js","assets/index-b40e5c0f.js","assets/index-a6b3472e.css","assets/hoist-non-react-statics.cjs-3f8ebaa8.js"])),Wb=O.lazy(()=>ut(()=>import("./InvestorsBlock-06e200c9.js"),["assets/InvestorsBlock-06e200c9.js","assets/index-b40e5c0f.js","assets/index-a6b3472e.css"])),Vb=O.lazy(()=>ut(()=>import("./Footer-81652986.js"),["assets/Footer-81652986.js","assets/index-b40e5c0f.js","assets/index-a6b3472e.css"])),Gb=O.lazy(()=>ut(()=>import("./ModalsManager-2b6b496b.js"),["assets/ModalsManager-2b6b496b.js","assets/index-b40e5c0f.js","assets/index-a6b3472e.css","assets/hoist-non-react-statics.cjs-3f8ebaa8.js"]));mc.setAppElement("#root");const Jb=()=>{const[t,e]=O.useState("main"),n=Ho(),[i,r]=O.useState([]),[s,o]=O.useState([]),a=O.useMemo(()=>async()=>{try{const[l,u]=await Promise.all([il(),rl()]);r(l),o(u)}catch(l){console.error("Error fetching data:",l)}},[]);return O.useEffect(()=>{a()},[a]),O.useEffect(()=>{const{hash:l}=n;if(l){const u=l.substring(1),c=document.getElementById(u);c&&window.scrollTo({top:c.offsetTop-100,behavior:"smooth"})}},[n]),O.useEffect(()=>{const l=()=>{document.querySelectorAll("section").forEach(c=>{const p=document.getElementById("about").offsetTop;window.scrollY<p-110&&e("main");const m=c.offsetTop,h=c.offsetHeight,g=c.getAttribute("id");if(window.scrollY>=m-100&&window.scrollY<m+h-100){e(g);const y=`/MistoHub/#${g}`;g!==null?window.history.pushState(null,"",y):window.history.pushState(null,"",window.location.pathname)}})};return window.addEventListener("scroll",l),()=>{window.removeEventListener("scroll",l)}},[]),b.jsxs(O.Suspense,{children:[b.jsx(Yc,{}),b.jsxs("main",{children:[b.jsx(mm,{}),b.jsx(Zf,{}),b.jsx(Fb,{}),b.jsx(Ub,{}),b.jsx(Wb,{people:s,companies:i}),b.jsx(Hb,{people:s,companies:i}),b.jsx(Dg,{}),b.jsx(_h,{})]}),b.jsx(Vb,{}),b.jsx(Gb,{activeSection:t})]})},Zb=Object.freeze(Object.defineProperty({__proto__:null,default:Jb},Symbol.toStringTag,{value:"Module"}));export{Ii as C,Zb as H,fe as I,mc as M,Pi as S,ee as a,ki as b,Xc as c,Au as d,Kb as e,Qb as f,$r as g,ln as h,we as i,Ce as m,Lo as n,Xb as p,df as s,Us as u};
